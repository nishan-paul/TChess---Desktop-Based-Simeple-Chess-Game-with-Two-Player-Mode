...
abstract class Classpiece {
    final int color;
    Classsquare currentSquare;
    BufferedImage img;
    public Classpiece(int color, Classsquare initSq, String img_file) {
        this.color = color;
    ...
    boolean move(Classsquare fin) {
        Classpiece occup = fin.getOccupyingPiece();
        if (occup != null) {
    ...
    Classsquare getPosition() {
        return currentSquare;
    }
    void setPosition(Classsquare sq) {
    ...
    int[] getLinearOccupations(Classsquare[][] board, int x, int y) {
        int lastYabove = 0;
        int lastXright = 7;
        int lastYbelow = 7;
        int lastXleft = 0;
    ...
    List<Classsquare> getDiagonalOccupations(Classsquare[][] board, int x, int y) {
        LinkedList<Classsquare> diagOccup = new LinkedList<>();
        int xNW = x - 1;
        int xSW = x - 1;
        int xNE = x + 1;
        int xSE = x + 1;
    ...
    abstract List<Classsquare> getLegalMoves(Classboard b);
}