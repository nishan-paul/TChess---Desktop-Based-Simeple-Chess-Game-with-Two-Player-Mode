...
public class Classqueen extends Classpiece {
    public Classqueen(int color, Classsquare initSq, String img_file) {
    ...
    public List<Classsquare> getLegalMoves(Classboard b) {
        ...
        List<Classsquare> bMoves = getDiagonalOccupations(board, x, y);
